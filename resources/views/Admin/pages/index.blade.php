            ...
            <div class="card">
              <div class="position-relative">
                <figure class="overflow-hidden mb-0 d-flex justify-content-center">
                  <img src="{{ asset('backend/assets/images/pbg.jpg')}}"
                class="rounded-top" alt="profile cover" style="width: 100%; height: 200px">
                </figure>
                <div class="d-flex justify-content-between align-items-center position-absolute top-90 w-100 px-2 px-md-4 mt-n4">
                  <div>
                    <img class="wd-70 rounded-circle" src="{{ asset('backend/assets/images/Profile.jpg' )}}" alt="profile">
                    <span class="h4 ms-3 text-light">{{ $admin->username }}</span>
                  </div>
                  <div class="d-none d-md-block">
                    <a href="{{ route('admin.profile.edit') }}" class="btn btn-primary btn-icon-text">
