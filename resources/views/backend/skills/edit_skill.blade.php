  ...
  <div class="col-md-12 grid-margin stretch-card">
						<div class="card">
							<div class="card-body">
								...
								<form class="forms-sample" method="POST" action="{{ route('update.skill',$skill->id) }}" enctype="multipart/form-data">
                                    @csrf
									<input type="hidden" name="id" value="{{ $skill->id }}">
									<div class="row mb-3">
										<label for="exampleInputEmail2" class="col-sm-3 col-form-label">Technology Name</label>
										<div class="col-sm-9">
											<input type="text" class="form-control" name="techonology" value="{{ $skill->technology_name }}">
										</div>
									</div>
                                    ...
                                    <div class="row mb-3">
										...
										<div class="col-sm-9">
										<img id="ShowImage" src="{{ asset($skill->icon) }}" alt="" style="width: 90px; height: 90px; border-radius: 10px;">
										</div>
									</div>
