  ...
  <div class="col-md-12 grid-margin stretch-card">
						<div class="card">
							<div class="card-body">
								...
								<form class="forms-sample" method="POST" action="{{ route('store.testimomy')}}" enctype="multipart/form-data">
                                    @csrf
									...
									<div class="row mb-3">
										...
										<div class="col-sm-9">
											<input type="text" class="form-control" name="occupation" placeholder="Managing Director, Safaricom" required>
										</div>
									</div>
                                    ...
                                    <div class="row mb-3">
										...
										<div class="col-sm-9">
											<textarea class="form-control" name="testimony" rows="3" placeholder="Add Message" required></textarea>
										</div>
									</div>
